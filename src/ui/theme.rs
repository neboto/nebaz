// ported from neboto-tui src/ui/theme.rs @ d483900
...
use crate::azure::resource::ResourceState;
...
pub struct Palette {
    ...
    /// The brand accent: chip highlights, the logo, the `@prefix` colour.
    /// neboto uses AWS orange here; nebaz uses Azure blue.
    pub brand: Color,
...
impl Palette {
    ...
    pub fn set_by_name(&mut self, key: &str, color: Color) -> bool {
        match key {
            "brand" | "accent_brand" | "aws_orange" => self.brand = color,
